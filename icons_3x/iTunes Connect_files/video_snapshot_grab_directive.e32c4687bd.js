            ...
            link: function(scope, element, attrs) {
                ...
                scope.$on('setVideoURL', function(event, data) { 
                    ...
                    if (!canPlayIt) {
                        ...
                        scope.copyPreviewExistingImage(data.thumbnailData, data.previewTimestamp, data.videoUrlFromServer);
                    }
                    else {
                        ...
                        // DOM security errors when we try to save a new poster frame.
                            ...
                            $.ajax({
                                ...
                                error: function(vidData) { 
                                    ...
                                    scope.copyPreviewExistingImage(data.thumbnailData, data.previewTimestamp, data.videoUrlFromServer, true);
                ...
                scope.copyPosterFrameToCanvas = function(indexInParentArray) {
                    var dataFromParent = scope.$parent.$parent.$parent.tempPageContent.previewVideos[indexInParentArray]; //scope.$parent.previewVideo;
                ...
                scope.onVideoLoadedFunc = function(e) {
                        if (scope.validateVideo()) { // comment this out to test DU error handling.
                            ...
                            if (e.data && e.data.data && e.data.data.previewImage && e.data.data.previewTimestamp) {
                                ...
                                scope.copyPreviewExistingImage(e.data.data.thumbnailData, e.data.data.previewTimestamp, e.data.data.videoUrlFromServer);
                            }
                            else {
